<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Hall.aspx.cs" Inherits="HMS.Pages.Hall" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <asp:UpdatePanel runat="server">
        <ContentTemplate>
            <asp:MultiView ID="mvHall" runat="server">
                        ...
                        <div class="card-header">
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <asp:Button ID="btnAddNew" runat="server" Text="Add Hall" CssClass="btn btn-default" TabIndex="3" OnClick="btnAddNew_Click" />
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <asp:GridView ID="gvHallMaster" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover" AllowPaging="True" PageSize="10" OnRowCommand="gvHallMaster_RowCommand" OnPageIndexChanging="gvHallMaster_PageIndexChanging">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Hall Description">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblHallDescription" runat="server" Text='<%# Bind("HallDescription") %>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Center"/>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Student Capacity">
                                                <ItemTemplate>
                                                       <asp:Label ID="lblStudentCapacity" runat="server" Text='<%# Bind("StudentCapacity") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                        ...
                        <div class="card-body">
                            <div class="form">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <asp:TextBox ID="txtHallName" runat="server" CssClass="form-control" TabIndex="1" MaxLength="10"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <span class="col-sm-3 control-label">Hall Description</span>
                                    <div class="col-sm-3">
                                        <asp:TextBox ID="txtHallDescription" runat="server" CssClass="form-control" TabIndex="2" MaxLength="30"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <span class="col-sm-3 control-label">Student Capacity</span>
                                    <div class="col-sm-3">
                                        <asp:TextBox ID="txtStudentCapacity" runat="server" CssClass="form-control" TabIndex="3" MaxLength="30"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        function pageLoad() {
            $(document).ready(function () {
                Validate = function () {
                    $('#<% = txtHallName.ClientID %>').addClass('validate[required]');
                    $('#<% = txtHallDescription.ClientID %>').addClass('validate[required]');
                    $('#<% = txtStudentCapacity.ClientID %>').addClass('validate[required]');
