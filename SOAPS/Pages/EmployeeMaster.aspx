<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmployeeMaster.aspx.cs" Inherits="HMS.Pages.EmployeeMaster" %>
                        ...
                        <div class="card-header">
                            <div class="form-group row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <asp:Button ID="btnAddNew" runat="server" Text="Add Employee" CssClass="btn btn-default" TabIndex="3" OnClick="btnAddNew_Click" />
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <asp:GridView ID="gvEmployeeMaster" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover" AllowPaging="True" PageSize="10" OnPageIndexChanging="gvEmployeeMaster_PageIndexChanging" OnRowCommand="gvEmployeeMaster_RowCommand">
                                        <Columns>
                    ...
                    <div class="card card-default">
                        <div class="card-body">
                            <div class="form">
                                ...
                                <div class="form-group row">
                                    <span class="col-sm-3 control-label">Employee Code</span>
                                    <div class="col-sm-3">
                                        <asp:TextBox ID="txtEmployeeCode" runat="server" CssClass="form-control" TabIndex="1" MaxLength="3" onkeydown="return ((event.keyCode>=48 && event.keyCode<=57) || (event.keyCode>=96 && event.keyCode<=105) || (event.keyCode==8 || event.keyCode==9 || event.keyCode==110 || event.keyCode==190));"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <span class="col-sm-3 control-label">Employee Name</span>
                                    <div class="col-sm-3">
                                        <asp:TextBox ID="txtName" runat="server" CssClass="form-control" TabIndex="2" MaxLength="30"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        function pageLoad() {
            $(document).ready(function () {
                Validate = function () {
                    $('#<% = txtEmployeeCode.ClientID %>').addClass('validate[required]');
